		...
		<div className="container py-10">
			<div className="mx-auto max-w-3xl space-y-8">
				...
				<div className="prose prose-slate dark:prose-invert max-w-none">
					<p>
						At Underdog Ranker, we take your privacy seriously. This
					...
					<p>
						When you connect your GitHub account, we only access
						public repository information to provide our ranking
						service. We do not access private repositories or
						personal data beyond what&apos;s publicly available.
					</p>
					...
					<p>
						...
						<Link
							href="mailto:privacy@underdogranker.com"
