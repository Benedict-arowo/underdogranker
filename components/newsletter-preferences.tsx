      ...
      <div className="container px-4 md:px-6 max-w-4xl">
        <Card className="animate-in">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Tell us what you're interested in and we'll curate the best underdogs for you
            </CardDescription>
          </CardHeader>
          <CardContent>
            ...
            <p className="text-center text-sm text-muted-foreground mt-6">
              {selectedTopics.length === 0
                ...
                : `You'll receive updates about ${selectedTopics.length} topic${selectedTopics.length > 1 ? "s" : ""}`}
            </p>
          </CardContent>
        </Card>
      </div>
